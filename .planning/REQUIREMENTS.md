...
- [x] **TARGET-02**: Runden-und-Passen's top-level radio group is relabeled "Vorlagen/Benutzerdefiniert" (was: preset/custom label).
...
| TARGET-02 | Phase 8: Rings Configuration | Complete |
